...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_link_color' => array(
			...
			'selector' => '#main-nav a, .fixed-header #main-nav a',
			'prop' => 'color',
		),
		...
		'main_nav_link_hover_color' => array(
			...
			'selector' => '#main-nav a:hover, .fixed-header #main-nav a:hover',
			'prop' => 'color',
		),
		...
		'main_nav_link_active_color' => array(
			...
			'selector' => '#main-nav .current_page_item a,  #main-nav .current-menu-item a, .fixed-header #main-nav .current-menu-item a',
			'prop' => 'color',
		),
		...
		'main_nav_link_active_hover_color' => array(
			...
			'selector' => '#main-nav .current_page_item a:hover,  #main-nav .current-menu-item a:hover, .fixed-header #main-nav .current-menu-item a:hover',
			'prop' => 'color',
		),
