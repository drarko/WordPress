...
/***************************************************************************/
	...
	///////////////////////////////////////
	// Custom cancel reply button
	///////////////////////////////////////
	function themify_cancel_comment_reply_button($html, $link, $text) {
		 $style = isset($_GET['replytocom']) ? '' : ' style="display:none;"';
		 $button = '<a href="#" id="cancel-comment-reply-link"' . $style . '><span>x</span> ';
		 return $button . $text . '</a>';
	}
	add_action('cancel_comment_reply_link', 'themify_cancel_comment_reply_button', 10, 3);
	...
	function themify_theme_comment($comment, $args, $depth) {
	   ...
	   <li id="comment-<?php comment_ID() ?>">
			<p class="comment-author">
				...
				<small class="comment-time"><?php comment_date( apply_filters( 'themify_comment_date', '' ) ); ?> @ <?php comment_time( apply_filters( 'themify_comment_time', '' ) ); ?><?php edit_comment_link( __('Edit', 'themify'),' [',']') ?></small>
			</p>
