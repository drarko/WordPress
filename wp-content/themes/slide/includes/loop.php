	...
	<div class="post-content">
		...
		<?php if($themify->hide_meta != 'yes'): ?>
			<p class="post-meta entry-meta">
				<span class="post-author"><?php echo themify_get_author_link() ?></span>  <span class="bullet">&sdot;</span>
				<span class="post-category"><?php the_category(', ') ?></span> <span class="bullet">&sdot;</span>
				<?php the_tags(' <span class="post-tag">', ', ', '</span> <span class="bullet">&sdot;</span>'); ?>
