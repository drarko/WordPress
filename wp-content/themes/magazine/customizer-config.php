...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_dropdown_link_font' => array(
			...
			'selector' => '#main-nav ul li a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a',
			'prop' => 'font',
		),
		...
		'main_nav_dropdown_link_color' => array(
			...
			'selector' => '#main-nav ul li a, #main-nav .mega-sub-menu li:after, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, .fixed-header #main-nav ul a',
			'prop' => 'color',
		),
