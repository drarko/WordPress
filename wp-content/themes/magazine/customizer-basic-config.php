...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'top_header_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Header Bar Background', 'themify' ),
			),
			'selector' => '#nav-bar',
			'prop' => 'background',
		),

		'top_header_font_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Header Font Color', 'themify' ),
			),
			'selector' => '#nav-bar .fa',
			'prop' => 'color',
		),

		'top_header_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Header Link Color', 'themify' ),
			),
			'selector' => '#nav-bar a',
			'prop' => 'color',
		),

		'top_header_link_hover_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Top Header Link Hover Color', 'themify' ),
			),
