...
/***************************************************************************/
	...
	array(
		  "name" 		=> "large_image_1", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 1", 
		  "description" => __('Large images in the post', 'themify'), 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_2", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 2", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_3", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 3", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_4", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 4", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_5", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 5", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_6", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 6", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_7", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 7", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_8", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 8", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_9", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 9", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_10", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 10", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_11", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 11", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_12", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 12", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_13", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 13", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_14", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 14", 
		  "description" => "", 
		  "type" 		=> "image"
		  ),
	array(
		  "name" 		=> "large_image_15", 
		  "std" 		=> "", 
		  "title" 		=> __('Large Image', 'themify') . " 15", 
		  "description" => "", 
		  "type" 		=> "image"
		  )
	);
