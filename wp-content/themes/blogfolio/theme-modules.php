		...
		$output .= '		<div class="uploader-fields">
			...
			$output .=	'</select> <small>' . __('(Off = disable autoplay)', 'themify') . '</small>
					...
					<p>
						...
						<input type="text" class="width2" name="setting-image_feature_width" value="' . themify_get( 'setting-image_feature_width' ) . '" /> ' . __('width', 'themify') . ' <small>(px)</small>  
						<input type="text" class="width2" name="setting-image_feature_height" value="' . themify_get( 'setting-image_feature_height' ) . '" /> ' . __('height', 'themify') . ' <small>(px)</small>
					</p>
					</div>';		
		return $output;
	}
	...
	function themify_default_post_layout($data=array()){
		...
		$output .= '<p>
				<span class="label">' . __('Image Size', 'themify') . '</span>  
					...
					<p>
						<span class="label">Large ' . __('Image size', 'themify') . '</span>  
						<input type="text" class="width2" name="setting-image_large_width" value="'.$data['setting-image_large_width'].'" /> ' . __('width', 'themify') . ' <small>(px)</small>  
						<input type="text" class="width2" name="setting-image_large_height" value="'.$data['setting-image_large_height'].'" /> ' . __('height', 'themify') . ' <small>(px)</small>
					</p>
					';
