...
class Themify {
	...
	static $content_width = 954;
	static $sidebar1_content_width = 675;
	...
	static $single_image_width = 944;
	static $single_image_height = 400;
	
	// Grid4
	static $grid4_width = 216;
	static $grid4_height = 140;
	
	// Grid3
	static $grid3_width = 298;
	static $grid3_height = 180;
	
	// Grid2
	static $grid2_width = 462;
	...
	static $list_thumb_image_height = 180;
