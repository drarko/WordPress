...
function themify_theme_enqueue_scripts(){
	...
	wp_enqueue_style( 'jscrollpane', THEME_URI . '/jquery.jscrollpane.css');
	...
	$enqueue_isotope = true;
	if ( themify_woocommerce_active() ) {
		if ( is_woocommerce() && themify_get( 'setting-shop_masonry_disabled' ) ) {
			$enqueue_isotope = false;
		}
	}
	wp_enqueue_script( 'themify-imagesloaded', THEME_URI . '/js/jquery.imagesloaded.js', array('jquery'), false, true );
	if ( $enqueue_isotope ) {
