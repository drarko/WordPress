/* Themify Custom Panel script to pick "sidebar-none" layout when user selects split scroll */
(function($){
	...
	$(document).ready(function(){
		...
		var $splitScroll = $('#split_scroll'),
			$layoutFields = $splitScroll.closest('.themify_write_panel').find( '.themify_field-layout' ),
		...
		$splitScroll.on( 'change', function(){
			if ( 'yes' === $splitScroll.val() ) {
