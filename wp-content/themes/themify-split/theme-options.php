...
class Themify {
    ...
    static $single_portfolio_image_height = 400;
    ...
    function template_redirect() {
        ...
        if (is_page()) {
            ...
            $hide_page_title = get_post_meta($this->page_id, 'hide_page_title', true);
            if (!empty($hide_page_title) && 'default' != $hide_page_title) {
                $this->page_title = $hide_page_title;
            } else {
                $this->page_title = themify_check('setting-hide_page_title') ? themify_get('setting-hide_page_title') : 'no';
            }
            if (themify_theme_has_split_scroll()) {
                $this->page_title = 'yes';
            }
            if ('yes' == $this->page_title) {
            ...
            $this->hide_header = themify_check('hide_header');
            ...
            $this->layout = (themify_get('layout') == 'sidebar-none' || themify_get('layout') == 'sidebar1' || themify_get('layout') == 'sidebar1 sidebar-left' || themify_get('layout') == 'sidebar2') ?
