...
/***************************************************************************/
	...
	function themify_pagination_infinite($data=array()){
		...
		$html .= '<br/><br/>';
		$html .= '<label for="setting-autoinfinite"><input class="disable-autoinfinite" type="checkbox" id="setting-autoinfinite" name="setting-autoinfinite" '.checked( themify_get( 'setting-autoinfinite' ), 'on', false ).'/> ' . __('Disable automatic infinite scroll', 'themify').'</label><br/>';
                $html .= '<label for="setting-autoinfinite-mobile"><input class="disable-autoinfinite" type="checkbox" id="setting-autoinfinite-mobile" name="setting-more_posts_mobile" '.checked( themify_get( 'setting-more_posts_mobile' ), 'on', false ).'/> ' . __('Disable automatic infinite scroll for mobile', 'themify').'</label>';
		$html .= '<br/><br/>';
