...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_dropdown_background' => array(
			...
			'selector' => '#main-nav li:not(.themify-widget-menu) > ul,
		...
		'main_nav_dropdown_link_font' => array(
			...
			'selector' => '#main-nav ul a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, #main-nav .mega-menu-posts .post a, #main-nav .has-mega-sub-menu .mega-sub-menu > ul a',
			'prop' => 'font',
		),
		...
		'main_nav_dropdown_link_background' => array(
			...
			'selector' => '#main-nav ul a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav .mega-menu-posts .post a, #main-nav .has-mega-sub-menu .mega-sub-menu > ul a',
			'prop' => 'background',
		),
		...
		'main_nav_dropdown_link_hover_color' => array(
		  ...
		  'selector' => '#main-nav ul a:hover, #main-nav .current_page_item ul a:hover, #main-nav ul .current_page_item a:hover, #main-nav .current-menu-item ul a:hover, #main-nav ul .current-menu-item a:hover, #main-nav .mega-menu-posts .post a:hover, #main-nav .has-mega-sub-menu .mega-sub-menu > ul a:hover',
		  'prop' => 'color',
		),
