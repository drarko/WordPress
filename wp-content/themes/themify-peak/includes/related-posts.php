		...
		<div class="related-posts">
			<?php while ( $related->have_posts() ) : $related->the_post(); ?>
				<article class="post type-post clearfix">
					<?php
					global $themify;
					if ( ! themify_check( $key . '_hide_image' )  && ( has_post_thumbnail() || themify_check( 'setting-auto_featured_image' ) ) && ($post_image = themify_get_image( $themify->auto_featured_image . 'setting=image_post_single&w=308&h=308&ignore=true' )) ) :?>
