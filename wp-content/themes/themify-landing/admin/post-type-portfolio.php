...
if ( ! function_exists( 'themify_default_portfolio_single_layout' ) ) {
	...
	function themify_default_portfolio_single_layout( $data=array() ) {
		 ...
		 * Image Dimensions
		 */
                $image_width = !empty($data[$prefix.'image_post_width'])?$data[$prefix.'image_post_width']:'';
                $image_heght = !empty($data[$prefix.'image_post_height'])?$data[$prefix.'image_post_width']:'';
		$output .= '
			<p>
				<span class="label">' . __('Image Size', 'themify') . '</span>
				<input type="text" class="width2" name="'.$prefix.'image_post_width" value="'.$image_width.'" /> ' . __('width', 'themify') . ' <small>(px)</small>
				<input type="text" class="width2" name="'.$prefix.'image_post_height" value="'.$image_heght.'" /> ' . __('height', 'themify') . ' <small>(px)</small>
			</p>';
...
if ( ! function_exists( 'themify_default_portfolio_index_layout' ) ) {
	...
	function themify_default_portfolio_index_layout( $data=array() ) {
		...
		$output .= '	<input type="hidden" name="' . esc_attr( $prefix ) . 'post_layout" class="val" value="'.$val.'" />
                ...
                * Enable Masonry
                */
                $binary_options[1]['selected'] = true;
                $output .=	'<p>
