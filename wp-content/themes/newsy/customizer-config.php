...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'sidebar_narrow_width' => array(
			'control' => array(
				'type'  => 'Themify_Width_Control',
				'label' => __( 'Sidebar Narrow', 'themify' ),
			),
			'selector' => '#sidebar-narrow',
			'prop' => 'width',
		),

		'sidebar_narrow_background' => array(
			'control' => array(
				'type'  => 'Themify_Background_Control',
				'label' => __( 'Sidebar Narrow Background', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#sidebar-narrow',
			'prop' => 'background',
		...
		'sidebar_narrow_border' => array(
			'control' => array(
				'type'  => 'Themify_Border_Control',
				'label' => __( 'Sidebar Narrow Border', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#sidebar-narrow',
			'prop' => 'border',
		...
		'sidebar_narrow_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
				'label' => __( 'Sidebar Narrow Padding', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#sidebar-narrow',
			'prop' => 'padding',
		...
		'sidebar_narrow_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
				'label' => __( 'Sidebar Narrow Margin', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#sidebar-narrow',
			'prop' => 'margin',
		...
		// Accordion Start ---------------------------
		'start_sidebar_narrow_acc' => $themify_customizer->accordion_start( __( 'Sidebar Narrow', 'themify' ) ),

		// Sidebar Font #sidebar

		'sidebar_narrow_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Sidebar Font', 'themify' ),
			),
		...
		// Sidebar Link #sidebar-narrow a

		'sidebar_narrow_link_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Sidebar Link', 'themify' ),
			),
			'selector' => '#sidebar-narrow a',
			'prop' => 'color',
		),

		'sidebar_narrow_link_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
			),
			'selector' => '#sidebar-narrow a',
		...
		// Sidebar Link Hover #sidebar-narrow a:hover

		'sidebar_narrow_link_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Sidebar Link Hover', 'themify' ),
			),
			'selector' => '#sidebar-narrow a:hover',
			'prop' => 'color',
		),

		'sidebar_narrow_link_hover_font' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Font_Control',
			),
		...
		// Sidebar Widget #sidebar-narrow .widget

		'sidebar_narrow_widget_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Sidebar Widget Container', 'themify' ),
			),
			'selector' => '#sidebar-narrow .widget',
			'prop' => 'color',
		),

		'sidebar_narrow_widget_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
			),
			'selector' => '#sidebar-narrow .widget',
		...
		'sidebar_narrow_widget_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '#sidebar-narrow .widget',
		...
		'sidebar_narrow_widget_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
			'selector' => '#sidebar-narrow .widget',
		...
		'sidebar_narrow_widget_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
			'selector' => '#sidebar-narrow .widget',
		...
		// Sidebar Widget Title #sidebar-narrow .widgettitle

		'sidebar_narrow_widget_title_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Sidebar Widget Title', 'themify' ),
			),
			'selector' => '#sidebar-narrow .widgettitle',
			'prop' => 'color',
		),

		'sidebar_narrow_widget_title_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
			),
			'selector' => '#sidebar-narrow .widgettitle',
		...
		'sidebar_narrow_widget_title_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'color_label' => __( 'Background Color', 'themify' ),
			),
		...
		'sidebar_narrow_widget_title_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '#sidebar-narrow .widgettitle',
		...
		'sidebar_narrow_widget_title_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
			'selector' => '#sidebar-narrow .widgettitle',
		...
		'sidebar_narrow_widget_title_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
			'selector' => '#sidebar-narrow .widgettitle',
		...
		// Sidebar Widget List Styling #sidebar-narrow .widget li

		'sidebar_narrow_widget_list_background' => array(
			'control' => array(
				'type'    => 'Themify_Color_Transparent_Control',
				'label'   => __( 'Sidebar Widget List Styling', 'themify' ),
				'color_label' => __( 'Background Color', 'themify' ),
			),
			'selector' => '#sidebar-narrow .widget li',
			'prop' => 'background',
		),

		'sidebar_narrow_widget_list_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '#sidebar-narrow .widget li',
		...
		'sidebar_narrow_widget_list_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
			'selector' => '#sidebar-narrow .widget li',
		...
		'sidebar_narrow_widget_list_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
			'selector' => '#sidebar-narrow .widget li',
		...
		'end_sidebar_narrow_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
