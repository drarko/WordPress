...
function themify_theme_enqueue_scripts(){
	...
	wp_enqueue_style( 'google-fonts', themify_https_esc('http://fonts.googleapis.com/css'). '?family=Merriweather&subset=latin,latin-ext');
...
/***************************************************************************/
	...
	add_action( 'themify_content_before', 'themify_theme_add_sidebar_alt' );
