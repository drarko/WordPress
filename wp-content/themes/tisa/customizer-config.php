...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'upperwrap_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Upper Wrap Background', 'themify' ),
			),
			'selector' => '#upperwrap',
			'prop' => 'background',
		),
		...
		// Accordion Start ---------------------------
		'start_slider_acc' => $themify_customizer->accordion_start( __( 'Slider', 'themify' ) ),
		...
		'slider_title_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Slider Title Color', 'themify' ),
				'show_label' => false,
			),
			'selector' => '.slide-post-title a',
			'prop' => 'color',
		...
		'slider_title_font_hover' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Slider Title Hover', 'themify' ),
			),
			'selector' => '.slide-post-title a:hover',
			'prop' => 'font',
		),

		'slider_title_color_hover' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Slider Title Color Hover', 'themify' ),
				'show_label' => false,
			),
			'selector' => '.slide-post-title a:hover',
			'prop' => 'color',
		...
		'slider_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
				'label'   => __( 'Slider Excerpt', 'themify' ),
			),
			'selector' => '.slide-excerpt',
			'prop' => 'font',
		),
		...
		'slider_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
				'label'   => __( 'Slider Content Color', 'themify' ),
				'show_label' => false,
			),
			'selector' => '.slide-excerpt',
			'prop' => 'color',
		...
		'slider_inner_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Slider Inner', 'themify' ),
			),
			'selector' => '.slide-content-wrap-inner',
			'prop' => 'border',
		),

		'slider_inner_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Slider Inner Padding', 'themify' ),
				'show_label' => false,
			),
			'selector' => '.slide-content-wrap-inner',
			'prop' => 'padding',
