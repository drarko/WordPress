...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		// Accordion Start ---------------------------
		'start_timeline_acc' => $themify_customizer->accordion_start( __( 'Timeline', 'themify' ) ),

		'timeline_nav_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Navigation Year', 'themify' ),
			),
			'selector' => '.timeline .timeline-nav',
			'prop' => 'background',
		),

		'timeline_nav_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.timeline .timeline-nav a',
			'prop' => 'color',
		),

		'timeline_nav_font' => array(
			'control' => array(
				'type'    => 'Themify_Font_Control',
			),
			'selector' => '.timeline .timeline-nav',
		...
		'timeline_nav_month_padding' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Navigation Month', 'themify' ),
			),
			'selector' => '.timeline .timeline-nav ul',
			'prop' => 'background',
		),

		'timeline_nav_month_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.timeline .timeline-nav ul a',
			'prop' => 'color',
		),

		'timeline_month_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Timeline Month', 'themify' ),
			),
			'selector' => '.timeline .timeline-month span',
			'prop' => 'background',
		),

		'timeline_month_color' => array(
			'control' => array(
				'type'    => 'Themify_Color_Control',
			),
			'selector' => '.timeline .timeline-month span',
		...
		'timeline_bar' => array(
			...
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Timeline Bar', 'themify' ),
			),
			'selector' => '.timeline .timeline-bar',
			'prop' => 'background',
		),
		'timeline_bar_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '.timeline .timeline-bar',
		...
		'timeline_dot' => array(
			...
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Timeline Dot', 'themify' ),
			),
			'selector' => '.timeline .post-dot, .timeline .timeline-start-dot',
			'prop' => 'background',
		),
		'timeline_dot_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '.timeline .post-dot, .timeline .timeline-start-dot',
		...
		'end_timeline_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
