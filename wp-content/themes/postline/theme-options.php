...
class Themify {
	...
	// Timeline
	static $timeline_post_width = 365;
	
	// Sorting Parameters
	public $order = 'DESC';
	public $orderby = 'date';

	public $is_shortcode_template = false;
	...
	function __construct() {
		...
		if($this->post_layout == '') $this->post_layout = 'timeline';
	...
	function template_redirect() {
		...
		if( is_page() ) {
			...
			if( 'timeline' === $this->post_layout ) {
				...
				$this->width = $post_image_width>=0? $post_image_width: $timeline_default_width;
				$this->height = $post_image_height>=0? $post_image_height: $timeline_default_height;
				$this->image_setting = 'ignore=true&';
			}
		}
		...
		if('timeline' != $this->post_layout && ( $this->layout == 'sidebar1' || $this->layout == 'sidebar1 sidebar-left' )) {
