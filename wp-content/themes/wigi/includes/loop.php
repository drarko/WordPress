		...
		<?php if($themify->hide_meta != 'yes'): ?>
			<div class="post-meta entry-meta">
	        	<?php  if( !themify_get('setting-comments_posts') && comments_open() ) : ?>
					<div class="post-comment"><?php comments_popup_link(__('No Comments', 'themify'), __('1 Comment', 'themify'), __('% Comments', 'themify')); ?></div>
				<?php endif; //post comment ?>

				<?php if($themify->hide_date != "yes"): ?>
					<div class="post-date entry-date updated"><?php echo get_the_date( apply_filters( 'themify_loop_date', '' ) ) ?></div>
				<?php endif; ?>

				<div class="clear">
					<span class="post-author"><?php _e( 'By', 'themify' ); ?> <?php echo themify_get_author_link(); ?></span>
