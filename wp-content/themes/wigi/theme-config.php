...
$themify_theme_config['panel']['styling']['tab']['background'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Overlay Background', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['top_bar'] = array(
	'title' => __('Top Bar', 'themify'),
	'id' => 'top_bar',
	'element' => array(
		array(
			...
			'module' => array(
				array(
					'name' => 'image-preview',
					'src' => 'uploads/bg/topbar/'
				),
				array(
					'name' => 'background-image',
					'target' => 'uploads/bg/topbar/'
				),
				'background-color',
				'background-repeat',
				'background-position',
		...
		array(
			'title' => __('Top Bar Hover', 'themify'),
			'id' => 'top_bar_hover',
			'selector' => '#topbar a:hover',
			'module' => array(
				'color',
				'text-decoration'
			)
