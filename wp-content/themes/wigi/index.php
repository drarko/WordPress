...
<div id="layout" class="clearfix">
	...
	<div id="content" class="clearfix">
		...
		?>
		<?php if(is_search()): ?>
			<div class=page-content><h1 class="page-title"><?php _e('Search Results for:','themify'); ?> <em><?php echo get_search_query(); ?></em></h1></div>
		<?php endif; ?>
		...
		<?php if(is_category() || is_tag() || is_tax() ): ?>
			<div class=page-content><h1 class="page-title"><?php single_cat_title(); ?></h1></div>
