...
$themify_theme_config['panel']['styling']['tab']['background'] = array(
	...
	'element' => array(
		array(
			'title' => __('Body Background (base background)', 'themify'),
			'id' => 'body_background',
			'selector' => 'body',
			'module' => array(
				array(
		...
		array(
			'title' => __('Pagewrap (overlay background)', 'themify'),
			'id' => 'pagewrap_overlay_background',
			'selector' => '#pagewrap',
...
$themify_theme_config['panel']['styling']['tab']['menu_page'] = array(
	'title' => __('Menu Page', 'themify'),
	'id' => 'menu_page',
	'element' => array(
		array(
			'title' => __('Menu Page Title', 'themify'),
			'id' => 'menu_page_title',
			'selector' => '.menu-title',
			'module' => array(
				'font-family',
		...
		array(
			'title' => __('Menu Category Title', 'themify'),
			'id' => 'menu_category_title',
		...
		array(
			'title' => __('Menu Item Title', 'themify'),
			'id' => 'menu_item_title',
...
$themify_theme_config['panel']['styling']['tab']['post_navigation'] = array(
	...
	'element' => array(
		...
		array(
			...
			'selector' => '.next-prev-post a:hover',
			'module' => array(
				'color',
				'text-decoration'
			)
...
$themify_theme_config['panel']['styling']['tab']['footer'] = array(
	...
	'element' => array(
		array(
			'title' => __('Footer Background', 'themify'),
