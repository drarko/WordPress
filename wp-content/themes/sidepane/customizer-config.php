...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'footer_text_position' => array(
			'control' => array(
				'type'    => 'Themify_Position_Control',
				'label'   => __( 'Footer Position', 'themify' ),
			),
			'selector' => '#footer-text',
			'prop' => 'position',
		),

		'footer_text_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Footer Background', 'themify' ),
			),
			'selector' => '#footer-text',
			'prop' => 'background',
		),

		'footer_text_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '#footer-text',
		...
		'footer_text_link_hover_color' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Color_Control',
		...
		'footer_text_link_hover_font' => array(
			'setting' => array( 'transport' => 'refresh' ),
			'control' => array(
				'type'    => 'Themify_Font_Control',
			),
