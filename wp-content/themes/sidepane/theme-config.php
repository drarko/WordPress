...
$themify_theme_config['panel']['styling']['tab']['content_area'] = array(
	'title' => __('Content Area', 'themify'),
	'id' => 'content_area',
	'element' => array(
		array(
			'title' => __('Content Area', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['site_logo'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Site Logo Margin (spacing)', 'themify'),
			'id' => 'site_logo_margin',
			'selector' => '#site-logo',
			'module' => array(
				'margin'
...
$themify_theme_config['panel']['styling']['tab']['site_description'] = array(
	...
	'element' => array(
		array(
			'title' => __('Site Description Margin (spacing)', 'themify'),
			'id' => 'site_description_margin',
...
$themify_theme_config['panel']['styling']['tab']['main_navigation'] = array(
	...
	'element' => array(
		array(
			'title' => __('Main Navigation Wrap', 'themify'),
			'id' => 'main_navigation_wrap',
			'selector' => '#main-nav-wrap',
			'module' => array(
				'margin',
				'divider',
				'border'
...
$themify_theme_config['panel']['styling']['tab']['sidebar'] = array(
	...
	'element' => array(
		array(
			'title' => __('Sidebar Panel', 'themify'),
			'id' => 'sidebar_pannel',
