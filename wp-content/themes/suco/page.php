...
<div id="upperwrap">
	...
	<?php if ( ! is_404() && have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<?php $themify->page_title = (themify_get('hide_page_title') != "default" && themify_check('hide_page_title')) ? themify_get('hide_page_title') : themify_get('setting-hide_page_title'); ?>
