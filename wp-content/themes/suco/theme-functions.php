...
function themify_theme_enqueue_scripts(){
	...
	wp_enqueue_style( 'google-fonts', themify_https_esc('http://fonts.googleapis.com/css'). '?family=Rokkitt&v1&subset=latin,latin-ext');
...
if ( ! function_exists('themify_theme_comment') ) {
	/**
	 * Custom Theme Comment. Can be overriden in child themes.
	...
	function themify_theme_comment($comment, $args, $depth) {
	   ...
	   ?>
		<li id="comment-<?php comment_ID() ?>">
			...
			<p class="reply"><?php comment_reply_link(array_merge( $args, array('add_below' => 'comment', 'reply_text' => __( '&larr; Reply' , 'themify' ), 'depth' => $depth, 'max_depth' => $args['max_depth']))) ?></p>
		<?php
	}
}
