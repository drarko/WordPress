...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Call of Action Text', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['background'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Navigation Bar Background', 'themify'),
			'id' => 'navigation_bar_background',
			'selector' => '#nav-bar',
		...
		array(
			'title' => __('Home Highlights Background', 'themify'),
			'id' => 'home_hightlights_background',
			'selector' => '.home-highlightswrap',
		...
		array(
			'title' => __('Content Background', 'themify'),
		...
		array(
			'title' => __('Footer Widget Background', 'themify'),
			'id' => 'footer_widget_background',
			'selector' => '.footer-widgetswrap',
...
$themify_theme_config['panel']['styling']['tab']['footer'] = array(
	...
	'element' => array(
		...
		array(
			...
			'id' => 'footer_link',
			'selector' => '#footer a, .footer-widgets a',
			'module' => array(
				'color',
				'text-decoration'
			)
		...
		array(
			...
			'id' => 'footer_hover',
			'selector' => '#footer a:hover, .footer-widgets a:hover',
			'module' => array(
				'color',
				'text-decoration'
			)
