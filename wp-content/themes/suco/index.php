...
<div id="upperwrap">
	...
	<?php
	/////////////////////////////////////////////////
	// Title for Posts page in Front page displays
	/////////////////////////////////////////////////
	if ( is_home() ) :
		$queried_object = get_queried_object();
		if ( isset( $queried_object->ID ) && ( get_option( 'page_on_front' ) != $queried_object->ID ) ) :
			if ( isset( $queried_object->post_title ) && '' != $queried_object->post_title ) : ?>
				<div class="pagewidth">
					<h1 class="page-title"><?php echo get_the_title( $queried_object->ID ); ?></h1>
				</div>
			<?php
			endif;
		endif;
