...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'footer_widget_wrapper_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Footer Widget Wrapper', 'themify' ),
			),
			'selector' => '.footer-widgetswrap',
			'prop' => 'background',
		),

		'footer_widget_wrapper_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
			),
			'selector' => '.footer-widgetswrap',
		...
		'footer_widget_wrapper_padding' => array(
			'control' => array(
				'type'  => 'Themify_Padding_Control',
			),
			'selector' => '.footer-widgetswrap',
		...
		'footer_widget_wrapper_margin' => array(
			'control' => array(
				'type'  => 'Themify_Margin_Control',
			),
			'selector' => '.footer-widgetswrap',
