	...
	<div id="content" class="clearfix">
		...
		if('' != $themify->query_category): ?>
			...
			<?php if(have_posts()): ?>
				...
				<?php
				$masonry_layout = '';
				if ( in_array( $themify->post_layout, array( 'masonry' ) ) ) {
					if ( 'masonry-enabled' == themify_theme_is_masonry_enabled() ) {
				...
				<!-- loops-wrapper -->
				<div id="loops-wrapper" class="loops-wrapper <?php echo esc_attr( $themify->layout . ' ' . $themify->post_layout ); ?> <?php echo isset( $themify->query_post_type ) && ! in_array( $themify->query_post_type, array( 'post', 'page' ) ) ? esc_attr( $themify->query_post_type ) : ''; ?> <?php echo esc_attr( $masonry_layout ); ?>">
