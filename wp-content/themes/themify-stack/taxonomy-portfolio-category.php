...
<div id="layout" class="pagewidth clearfix">
	...
	<div id="content">
		...
		<?php if (have_posts()) : ?>
			...
			<!-- loops-wrapper -->
			<div id="loops-wrapper" class="loops-wrapper portfolio portfolio-taxonomy <?php echo esc_attr( "$themify->layout $themify->post_layout" ); ?> <?php echo 'masonry-enabled' == themify_theme_is_masonry_enabled() ? esc_attr( 'masonry-layout' ) : '' ?>">
