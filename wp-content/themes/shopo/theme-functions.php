...
function themify_theme_enqueue_scripts(){
	...
	//Google Web Fonts
	wp_enqueue_style( 'google-fonts', themify_https_esc('http://fonts.googleapis.com/css'). '?family=Cambo&subset=latin,latin-ext');
...
function themify_register_custom_nav() {
	if (function_exists('register_nav_menus')) {
		register_nav_menus( array(
			'top-nav' => __( 'Top Bar Navigation', 'themify' ),
