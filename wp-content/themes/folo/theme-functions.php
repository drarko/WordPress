...
function themify_theme_enqueue_scripts(){
	...
	wp_enqueue_style( 'google-fonts', themify_https_esc('http://fonts.googleapis.com/css'). '?family=Arvo&subset=latin,latin-ext');
	...
	//roundabout, slider
	wp_enqueue_script( 'roundabout', THEME_URI . '/js/jquery.roundabout.js', array('jquery'), false, true );
	
	//easing, library required for animations
	wp_enqueue_script( 'easing', THEME_URI . '/js/jquery.easing.js', array('jquery'), false, true );
	...
	//sizes, support for querying and setting CSS dimensions
	wp_enqueue_script( 'sizes',	THEME_URI . '/js/jquery.sizes.min.js', array('jquery'), false, true );
...
/***************************************************************************/
	...
	///////////////////////////////////////
	// Add before & after_signup_form_html to wp-signup.php template
	///////////////////////////////////////
	add_action('before_signup_form','themify_before_signup_form_html');
	function themify_before_signup_form_html() {
		$html = '<div id="upperwrap">
	...
	// Add after_signup_form_html
	add_action('after_signup_form','themify_after_signup_form_html');
	function themify_after_signup_form_html() {
		$html = '</div><!-- /#layout -->';
		echo $html;
	}
	...
	function themify_register_custom_nav() {
		if (function_exists('register_nav_menus')) {
			register_nav_menus( array(
				'main-nav-left' => __( 'Top Left Navigation', 'themify' ),
				'main-nav-right' => __( 'Top Right Navigation', 'themify' ),
	...
	function themify_default_main_nav() {
		echo '<ul id="main-nav-left" class="main-nav">';
