	...
	<div class="post-content">
		...
		<?php if($themify->hide_meta != 'yes'): ?>
			<p class="post-meta entry-meta">
				<span class="post-author"><?php _e( 'by', 'themify' ); ?> <?php echo themify_get_author_link(); ?></span> <span class="divider"></span>
				<?php  if( !themify_get('setting-comments_posts') && comments_open() ) : ?>
					<span class="post-comment"><?php comments_popup_link( __( '0 Comments', 'themify' ), __( '1 Comment', 'themify' ), __( '% Comments', 'themify' ) ); ?></span> <span class="divider"></span>
				<?php endif; //post comment ?>
				<span class="post-category"><?php the_category(', ') ?></span> <span class="divider"></span>
				<?php the_tags(' <span class="post-tag">' . __('Tags:','themify') . ' ', ', ', '</span>'); ?>
			</p>
		<?php endif; ?>
