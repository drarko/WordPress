...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Homepage Highlights', 'themify'),
		...
		array(
			'title' => __('Homepage Widgets', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['background'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Upper Wrap Background', 'themify'),
			'id' => 'upper_wrap_background',
			'selector' => '#upperwrap',
...
$themify_theme_config['panel']['styling']['tab']['header'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Header Font Color', 'themify'),
...
$themify_theme_config['panel']['styling']['tab']['site_logo'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Site Logo Box', 'themify'),
			'id' => 'site_logo_box',
			'selector' => '.logo-wrap-outer',
			'module' => array(
				'width',
				'height',
				'position'
		...
		array(
			'title' => __('Site Logo Box Style', 'themify'),
			'id' => 'site_logo_box_style',
			'selector' => '.logo-wrap',
			'module' => array(
				array(
					'name' => 'image-preview',
		...
		array(
			'title' => __('Site Logo Box Inner Border', 'themify'),
			'id' => 'site_logo_box_inner_border',
			'selector' => '.logo-wrap-inner',
			'module' => array(
				'border'
			)
		)
...
$themify_theme_config['panel']['styling']['tab']['main_navigation'] = array(
	...
	'element' => array(
		...
		array(
			...
			'selector' => '#header .main-nav a:hover, #header .main-nav li:hover > a',
			'module' => array(
				'color',
				'text-decoration',
				'background-color'
		...
		array(
			...
			'selector' => '#header .main-nav .current_page_item a, #header .main-nav .current-menu-item a',
			'module' => array(
				'color',
				'background-color'
			)
		...
		array(
			...
			'selector' => '#header .main-nav .current_page_item a:hover, #header .main-nav .current-menu-item a:hover',
			'module' => array(
				'color',
				'background-color'
			)
		...
		array(
			...
			'id' => 'dropdown_link',
			'selector' => '#header .main-nav ul a, #header .main-nav .current_page_item ul a, #header .main-nav ul .current_page_item a, #header .main-nav .current-menu-item ul a, #header .main-nav ul .current-menu-item a, #header .main-nav li:hover > ul a',
			'module' => array(
				'font-family',
				'font-size',
				'color',
		...
		array(
			...
			'id' => 'dropdown_hover',
			'selector' => '#header .main-nav ul a:hover, #header .main-nav .current_page_item ul a:hover, #header .main-nav ul .current_page_item a:hover, #header .main-nav .current-menu-item ul a:hover, #header .main-nav ul .current-menu-item a:hover, #header .main-nav li:hover > ul a:hover',
			'module' => array(
				'color',
				'background-color'
			)
