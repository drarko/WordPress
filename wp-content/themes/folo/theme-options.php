...
class Themify {
	...
	static $sidebar1_content_width = 650;
	
	// Default Single Post Layout
	static $single_content_width = 978;
	static $single_sidebar1_content_width = 650;
	
	// Default Single Image Size
	static $single_image_width = 964;
	static $single_image_height = 400;
	
	// Grid4
	static $grid4_width = 208;
	static $grid4_height = 140;
	
	// Grid3
	static $grid3_width = 292;
	static $grid3_height = 180;
	
	// Grid2
	static $grid2_width = 460;
	static $grid2_height = 250;
	
	// List Large
	static $list_large_image_width = 676;
	static $list_large_image_height = 390;
	 
	// List Thumb
	static $list_thumb_image_width = 226;
	static $list_thumb_image_height = 200;
	
	// List Grid2 Thumb
	static $grid2_thumb_width = 116;
	static $grid2_thumb_height = 100;
	
	// List Post
	static $list_post_width = 964;
