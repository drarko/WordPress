...
class Themify {
	...
	function __construct() {
		...
		$this->media_position = themify_check('setting-default_media_position')? themify_get('setting-default_media_position') : 'below';
	...
	function template_redirect() {
		...
		if( is_page() ) {
			...
			$this->media_position = themify_check('_media_position')? themify_get('_media_position') : 'below';
			...
			if( '' != $portfolio_query_category ) {
				...
				$this->layout = (themify_get('page_layout') != 'default' && themify_check('page_layout')) ? themify_get('page_layout') : themify_get('setting-default_portfolio_index_layout');
...
function themify_global_options() {
	...
	global $themify;
	$themify = new Themify();
	$themify->theme = new Themify_Bold();
}
