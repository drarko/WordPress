...
<article id="post-<?php the_id(); ?>" <?php post_class("post clearfix " . $themify->theme->get_categories_as_classes(get_the_id()) . ' ' . $themify->theme->get_post_classes(get_the_id())); ?>>
	...
	<div class="post-inner">
		...
		<?php if($themify->hide_title != 'yes'): ?>
			...
			<?php else: ?>
				<h1 class="post-title entry-title"><a href="<?php echo $themify->theme->get_featured_image_link(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
