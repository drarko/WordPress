...
/***************************************************************************/
	...
	function themify_homepage_featurebox($data=array()){
		...
		$speed_options = array(__('Fast', 'themify') => 200, __('Normal', 'themify') => 1000, __('Slow', 'themify') => 2000);
	...
	function themify_homepage_featurebox_action($data=array()){
		...
		jQuery(document).ready(function($){
            $('.slides').cycle({ 
                fx:     '<?php echo '' != $data['setting-feature_box_effect']? $data['setting-feature_box_effect']: 'scrollHorz'; ?>', 
                speed:   <?php echo '' != $data['setting-feature_box_speed']? $data['setting-feature_box_speed']: '200'; ?>, 
