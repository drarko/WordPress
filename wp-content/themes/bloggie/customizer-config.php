...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'top_nav_link_active_background' => array(
			...
			'selector' => '.topbar-nav .current_page_item a,  .topbar-nav .current-menu-item a',
			'prop' => 'background',
		),
		...
		'top_nav_link_active_hover_background' => array(
			...
			'selector' => '.topbar-nav .current_page_item a:hover,  .topbar-nav .current-menu-item a:hover',
			'prop' => 'background',
		),
		...
		'top_nav_dropdown_link_font' => array(
			...
			'selector' => '.topbar-nav ul a, .topbar-nav .current_page_item ul a, .topbar-nav ul .current_page_item a, .topbar-nav .current-menu-item ul a, .topbar-nav ul .current-menu-item a',
			'prop' => 'font',
		),
		...
		'top_nav_dropdown_link_hover_background' => array(
			...
			'selector' => '.topbar-nav ul a:hover,  .topbar-nav .current_page_item ul a:hover,  .topbar-nav ul .current_page_item a:hover,  .topbar-nav .current-menu-item ul a:hover,  .topbar-nav ul .current-menu-item a:hover',
			'prop' => 'background',
		),
