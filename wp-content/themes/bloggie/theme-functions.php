...
function themify_theme_enqueue_scripts(){
	...
	//roundabout, slider
	wp_enqueue_script( 'cycle', THEME_URI . '/js/jquery.cycle.js', array('jquery'), false, true );
...
/***************************************************************************/	
	...
	function themify_register_custom_nav() {
		if (function_exists('register_nav_menus')) {
			register_nav_menus( array(
				...
				'secondary-nav' => __( 'Secondary Navigation', 'themify' ),
			) );
		}
	}
	...
	// Default Secondary Nav Function
	function default_secondary_nav() {
		echo '<ul id="secondary-nav" class="secondary-nav">';
